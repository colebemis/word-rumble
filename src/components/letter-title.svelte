...
<button
  ...
  class={clsx(
    "aspect-square rounded-lg border-2 [container-type:size] transition-[transform,color,background-color,border-color] will-change-transform active:scale-95 relative border-b-4",
    "focus-visible:outline-2 focus-visible:outline-offset-[3px] focus-visible:outline-accent-11",
    selected
